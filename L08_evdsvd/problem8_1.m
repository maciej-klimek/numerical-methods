...
result = V' * [ y1; y2 ];                 % PCA - rzutowanie na wektory wlasne

% Wynik separacji  
figure;
subplot(211); plot(n,result(1,:),'b'); title('x1est(n)'); grid;
subplot(212); plot(n,result(2,:),'b'); title('x2est(n)'); grid;
soundsc(result(1,:),fpr1), pause
soundsc(result(2,:),fpr2), pause