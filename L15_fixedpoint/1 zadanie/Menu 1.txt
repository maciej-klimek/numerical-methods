...
# FLoat32 przykład
println(eps(Float32))
println(bits(eps(Float32)))
println(bits(1 .+eps(Float32)/2))
println(bits(1 .+eps(Float32)))
println(bits(1 .+2*eps(Float32)))
println(bits(Float32(Inf)))
println(bits(Float32(-Inf)))
println(bits(Float32(NaN)))
println(bits(Float32(-0.009765625)))
println(bitstring(reinterpret(Float32, UInt32(parse(Int, bitstring(Float32(2.0)^(-126-3)), base=2))))) 
println(Float32((10.)^3)+Float32((10. )^(3-8)))
...
# Float16
value_float16 = Float16(3.14)
println("Float16: ", value_float16)

# Float32
value_float32 = Float32(3.14)
println("Float32: ", value_float32)

# Float64
value_float64 = 3.14  # Float64 jest domyślnym typem dla zmiennoprzecinkowych
...
A = Int64(1234)    # Tworzy zmienną A i przypisuje jej wartość 1234 typu Int64
F = Float16(1.125)  # Tworzy zmienną F i przypisuje jej wartość 1.125 typu Float16
B = Float64(A)     # Tworzy zmienną B i przypisuje jej wartość zmiennej A (typu Int64), ale jako Float64
