...
figure; imshow( abs(wsp) ); title('Wspolczynniki DCT2');  
...
figure;
subplot(121); imshow(w); title('Wybrane wspo lczynniki DCT');
subplot(122); imshow(img2); title('Zsyntezowany obraz'); 
...
% Moim zdaniem współczynnik  dla figure5 D2 DTC przy wartości k= -11 i 11637 jest znośny
% dla figure 4 jest to 